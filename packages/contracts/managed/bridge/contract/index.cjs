...
class _CoinPreimage_0 {
  alignment() {
    return _descriptor_5.alignment().concat(_descriptor_6.alignment().concat(_descriptor_0.alignment().concat(_descriptor_13.alignment())));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_5.toValue(value_0.info).concat(_descriptor_6.toValue(value_0.dataType).concat(_descriptor_0.toValue(value_0.data).concat(_descriptor_13.toValue(value_0.domain_sep))));
  }
}
...
class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      initiateBridge: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(secretHashed_0).concat(_descriptor_2.toValue(amount_0).concat(_descriptor_5.toValue(coin_0))),
      ...
      completeBridge: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`completeBridge: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        ...
        const result_0 = this._completeBridge_0(context,
                                                partialProofData,
                                                secret_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData };
    ...
    this.impureCircuits = {
      ...
      completeBridge: this.circuits.completeBridge
    };
  }
  initialState(...args_0) {
    if (args_0.length !== 1) {
    ...
    state_0.setOperation('completeBridge', new __compactRuntime.ContractOperation());
    const context = {
  ...
  _receive_0(context, partialProofData, coin_0) {
    const recipient_0 = this._right_0(_descriptor_8.fromValue(Contract._query(context,
                                                                              partialProofData,
                                                                              [
                                                                               { dup: { n: 2 } },
                                                                               { idx: { cached: true,
  ...
  _send_0(context, partialProofData, input_0, recipient_0, value_0) {
    const selfAddr_0 = _descriptor_8.fromValue(Contract._query(context,
                                                               partialProofData,
                                                               [
                                                                { dup: { n: 2 } },
                                                                { idx: { cached: true,
  ...
  _initiateBridge_0(context, partialProofData, secretHashed_0, amount_0, coin_0)
  {
                                                            ...
                                                            result: undefined } }]).value))
    {
      ...
      if (this._equal_2(_descriptor_4.fromValue(Contract._query(context,
                                                                partialProofData,
                                                                [
                                                                 { dup: { n: 0 } },
                                                                 { idx: { cached: false,
                        ...
                        0n))
      {
        const tmp_0 = this._right_0(_descriptor_8.fromValue(Contract._query(context,
                                                                            partialProofData,
                                                                            [
                                                                             { dup: { n: 2 } },
                                                                             { idx: { cached: true,
                                                 ...
                                                 _descriptor_4.fromValue(Contract._query(context,
                                                                                         ...
                                                                                         [
                                                                                          ...
                                                                                          { popeq: { cached: false,
                                                                                                     result: undefined } }]).value),
                                                 disclosedCoin_0);
        const tmp_2 = this._right_0(_descriptor_8.fromValue(Contract._query(context,
                                                                            partialProofData,
                                                                            [
                                                                             { dup: { n: 2 } },
                                                                             { idx: { cached: true,
  ...
  _completeBridge_0(context, partialProofData, secret_0) {
    const hashedSecret_0 = this._persistentHash_0(secret_0);
    if (!_descriptor_6.fromValue(Contract._query(context,
                                                 partialProofData,
                                                 [
                                                  { dup: { n: 0 } },
                                                           ...
                                                           path: [
                                                                  { tag: 'value',
                                                                    value: { value: _descriptor_16.toValue(0n),
                                                                             alignment: _descriptor_16.alignment() } }] } },
                                                  { push: { storage: false,
                                                            value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(hashedSecret_0),
                                                                                                         alignment: _descriptor_0.alignment() }).encode() } },
                                                  'member',
                                                  { popeq: { cached: true,
                                                             result: undefined } }]).value))
    {
      ...
      if (_descriptor_1.fromValue(Contract._query(context,
                                                  ...
                                                  [
                                                   ...
                                                   { idx: { cached: false,
                                                            ...
                                                            path: [
                                                                   { tag: 'value',
                                                                     value: { value: _descriptor_0.toValue(hashedSecret_0),
                                                                              alignment: _descriptor_0.alignment() } }] } },
                                                   { popeq: { cached: false,
                                                              result: undefined } }]).value)
          ===
          1)
      {
        ...
        if (sendResult_0.change.is_some) {
          ...
          const tmp_1 = this._right_0(_descriptor_8.fromValue(Contract._query(context,
                                                                              partialProofData,
                                                                              [
                                                                               { dup: { n: 2 } },
                                                                               { idx: { cached: true,
